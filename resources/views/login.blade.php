...
<body class="bg-gradient-to-br from-blue-50 to-blue-200 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md bg-white/90 rounded-2xl shadow-xl p-10 border border-blue-100 backdrop-blur-lg">
        <div class="flex flex-col items-center mb-8">
            ...
            <h2 class="text-3xl font-extrabold text-blue-700 tracking-tight">Sign in to your account</h2>
        </div>
        @if(session('error'))
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-base font-semibold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition">Sign in</button>
        </form>
